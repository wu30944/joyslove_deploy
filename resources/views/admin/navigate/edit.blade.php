...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content">
            <a href="{{route('navigate.index')}}">
                <button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 權限管理
                </button>
            </a>
            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
            <form class="form-horizontal m-t-md" action="{{route('navigate.update',$rule->id)}}" method="POST">
                ...
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">權限名稱：</label>
                    <div class="col-sm-3">
