    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-title">
                <h5>@lang('default.add_admin')</h5>
            </div>
            <div class="ibox-content">
                <a class="menuid btn btn-primary btn-sm" href="javascript:history.go(-1)">@lang('default.return')</a>
                <a href="{{route('admins.index')}}"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> @lang('default.admin_management')</button></a>
                ...
                <form class="form-horizontal m-t-md" action="{{ route('admins.store') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">@lang('default.account_name')：</label>
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="name" value="{{old('name')}}" required data-msg-required="@lang('message.err_account_name')">
                            @if ($errors->has('name'))
                    ...
                    <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">@lang('default.password')：</label>
                        <div class="input-group col-sm-2">
                            <input type="password" class="form-control" name="password" required data-msg-required="@lang('message.err_password')">
                    ...
                    <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">@lang('default.avatar')：</label>
                        <div class="input-group col-sm-2">
