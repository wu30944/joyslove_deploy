        ...
        <div class="ibox-content">
            ...
            <form class="form-horizontal m-t-md" id="flavor_create">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" id="create_zh_company_name" name="create_zh_company_name" value="{{old('name')}}" class="form-control" required data-msg-required="{{trans('message.err_flavor_name')}}">
                        @if ($errors->has('name'))
