...
<div class="header" id="home">
    ...
    <div class="top-bar">
        <div class="header-top_w3layouts">
            <div class="forms">
                <p><span class="fa fa-map-marker" aria-hidden="true"></span>100台北市中正區八德路一段121巷18號</p>
        ...
        <div class="choose-main">
            ...
            <div class="col-md-7 choose-right">
                <div class="col-md-6 choose-right-top">
                    ...
                    <a class="active" href="#" data-toggle="modal" data-target="#myModal">Read More</a>
                </div>
                <div class="col-md-6 choose-right-top">
                    <h4>150 Tables</h4>
                    <p>Duis sit amet posuere justo, sit amet finibus urna. Aenean elementum diam nec laoreet sodales. Morbi vulputate tempor
    ...
    <div class="container">
        <div class="comments-main">
            ...
            <div class="comments-top">
                <div class="col-md-5 comments-bottom">
