...
class AdminsController extends BaseController
{
    ...
    public function delete($id)
    {
        ...
        if(empty($admin))
        {
            flash(trans('message.delete_fail'))->error()->important();
        ...
        flash(trans('message.delete_successful'))->success()->important();
    ...
    public function status($status,$id)
    {
        ...
        if(empty($admin))
        {
            flash(trans('message.option_fail'))->error()->important();
        ...
        flash(trans('message.update_successful'))->success()->important();
    ...
    public function loginHandle(AdminLoginRequest $request)
    {
       $result = $this->adminsService->login($request);
        ...
        if(!$result)
        {
            return viewError(trans('message.login_fail'),'login');
        }

        return viewError(trans('message.login_successful'),'index.index','success');
    }
